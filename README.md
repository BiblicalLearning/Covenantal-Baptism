...
- 📄 Downloadable 1-page outline for group leaders
- 🖨️ Print certificate on completion
- ♿ Accessible design
...
- **Zero tracking** — No analytics or cookies

---

## 🎨 Design

- **Dark Theme:** Navy (#0a0e1a) with Gold (#c9a227) accents
- **Light Theme:** Clean white with deep blue accents
- **Typography:** Cinzel (headings) + Cormorant Garamond (body)
- **Consistent with Kingdom Discipleship series branding**

---

## 📂 Part of the Kingdom Discipleship Series

| Study | Link |
|-------|------|
| 🏰 The Kingdom of God | [View Study](https://biblicallearning.github.io/kingdom-discipleship/) |
...
Free to use for personal and ministry purposes. Please maintain attribution.
...
- X/Twitter: [@ServingNChrist](https://x.com/ServingNChrist)
- Support: [CashApp - $ServingNChrist](https://cash.app/$ServingNChrist)
